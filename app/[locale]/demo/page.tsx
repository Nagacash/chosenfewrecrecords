...
export default async function DemoPage({
  ...
  return (
    <section className="relative overflow-hidden bg-surface px-5 pb-20 pt-28 md:px-10">
      <div className="relative z-10 max-w-xl">
        <SectionLabel>{t("label")}</SectionLabel>
        <h1 className="mb-3 font-display text-[clamp(40px,5vw,72px)] font-black uppercase leading-[0.9] tracking-tight text-white">
          {t("headline")}
        </h1>
